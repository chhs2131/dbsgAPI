...
public class IpoApiController {
    ...
    @ApiResponse(responseCode = "200", content = @Content(array = @ArraySchema(schema = @Schema(implementation = IpoSummaryDto.class))))
    ...
    @ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = IpoDetailDto.class)))
    ...
    @ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = IpoDto.class)))
    ...
    @ApiResponse(responseCode = "200", content = @Content(array = @ArraySchema(schema = @Schema(implementation = IpoCommentDto.class))))
    ...
    @ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = IpoCommentDto.class)))
    ...
    @ApiResponse(responseCode = "200", content = @Content(array = @ArraySchema(schema = @Schema(implementation = IpoUnderwriterDto.class))))
